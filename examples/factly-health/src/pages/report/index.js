...
const ReportPage = () => {
  ...
  const [pdf, setPdf] = useState({ url: '', fileName: '' });
  useEffect(() => {
  ...
  return (
    <Layout>
          ...
          <div className={styles.coverContainer}>
            ...
            <div className={styles.coverOptions}>
              ...
              <button
                ...
                onClick={() =>
                  setPdf({
                    url: '/Health Misinformation Report_Factly.pdf',
                    fileName: 'Health Misinformation Report',
                    show: true,
                  })
                }
              >
      ...
      <Lightbox url={pdf.url} fileName={pdf.fileName} />
