              ...
              {[1, 2, 3, 4, 5].map(() => (
                <div className="flex flex-col w-full sm:w-1/3 p-4">
                  ...
                  <p className="text-lg py-2 break-all">
                    A bachelor’s degree in mathematics and master’s in social science, she is driven
                    by ardent desire to work with
                  </p>
                  <a href="mailto:info@factly.in" className="text-blue-400 text-base py-2">
                    info@factly.in
                  </a>
                </div>
              ))}
          ...
          <section id="what-we-do">
            ...
            <div className="my-6 pb-6 text-gray-800 flex flex-wrap">
              <div className="flex flex-col flex-auto p-4">
                <h2 className="font-bold text-xl mb-2">Data Journalism/Fact Check</h2>
                <p>
                  Factly’s written and visual stories lay out facts with evidence and help separate
