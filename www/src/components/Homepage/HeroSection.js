    ...
    <main>
      ...
      >
        <div class="mx-auto">
          ...
          <div class="max-w-[1240px] mx-auto w-full my-8 flex">
            <div
              class="mb-0 flex-grow-0 self-start "
              style={{ flexBasis: "63.33%" }}
            >
              {/* <figure class="size-large is-resized anariel-lines">
                <img
                  decoding="async"
                  src="https://www.anarieldesign.com/wp-content/uploads/2021/06/deco-lines-1.png"
                  alt=""
                  class="wp-image-15111"
                  width="53"
                  height="31"
                />
              </figure> */}
              <h1 id="" className="text-6xl my-4">
                Professional <span class="accent-text">Dega</span> Themes and
                Templates. <br />
          ...
          <div class="custom-shape-divider-bottom-1622446369 alignfull absolute bottom-0 left-0 w-full overflow-hidden rotate-180">
            {" "}
            <svg
              data-name="Layer 1"
