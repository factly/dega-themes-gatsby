      ...
      <div sx={{
        ...
        <div sx={{
          ...
          <ul sx={{
            ...
            <li> <a href="#"> Members / Subscriptions</a>
              <ul sx={{
                ml: '20px',
                mt: '8px'
              }}>
                <li><a href="#"> Remove ‘Log In’ and ‘Subscribe’ from Header</a></li>
                <li><a href="#">Using Portal for Header ‘Log in’ and ‘Subscribe’ Links</a></li>
                <li><a href="#">Remove the ‘Public’, ‘Members’ and ‘Paid’ Labels from Post Card</a></li>
                <li><a href="#"> Embed the Subscribe Form in the Middle of a Blog Post</a></li>
                <li><a href="#"> Remove Ghost Portal / The Bottom Right Button</a></li>
                <li><a href="#"> Membership Troubleshooting Tips</a></li>
              </ul>
            </li>
            <li><a href='#'> Home Hero</a>
              <ul sx={{
                ml: '20px',
                mt: '8px'
              }}>
                <li><a href='#' > Subscribe list</a></li>
                <li> <a href="#"> Remove Subscribe Form</a> </li>
                <li> <a href="#"> Remove Home Hero</a> </li>
              </ul>
            </li>
            <li><a href='#'> Pages</a>
              <ul sx={{
                ...
                <li><a href='#' > Homepage Podcasts</a></li>
                <li> <a href="#"> Show All Posts on the Homepage</a> </li>
                <li> <a href="#">Blog Page</a> </li>
                <li> <a href="#"> Contact Page</a> </li>
              </ul>
            </li>
            <li><a href='#'> RSS Feed URL</a>
              <ul sx={{
                ml: '20px',
                mt: '8px'
              }}>
                <li> <a href="#">Podcast RSS Feed URL</a> </li>
                <li> <a href="#"> Blog RSS Feed URL</a> </li>
              </ul>
            </li>
            <li><a href='#'> Dark Mode</a>
              <ul sx={{
                ml: '20px',
                mt: '8px'
              }}>
                <li><a href='#' > Disable Dark Mode</a></li>
                <li> <a href="#"> Disable Light Mode</a> </li>
                <li> <a href="#">Remove the Header Dark Mode Switch Button</a> </li>
                <li> <a href="#"> Add Different Logo Images for Light and Dark Modes</a> </li>
                <li><a href='#' > Add Different Hero Image for Light and Dark Modes</a></li>
              </ul>
            </li>
            <li><a href='#'> Navigation</a>
              <ul sx={{
                ...
                <li><a href='#' > Secondary Navigation / Footer</a></li>
              </ul>
            </li>
            <li><a href='#'> Search</a>
              <ul sx={{
                ...
                <li><a href='#' > ghostHunter Slow Search</a></li>
              </ul>
            </li>
            ...
            <li><a href='#' >Social Sharing Icons</a></li>
            <li><a href='#' >Footer Social Media Icons</a></li>
            ...
            <li><a href="#">Changing Colors with CSS Variables</a></li>
            <li><a href="#">Customize Home Post Card Image Height</a></li>
            <li><a href="#">Customize Home Hero Image Size</a></li>
            ...
            <li><a href='#'> Theme Development</a>
              <ul sx={{
                ...
                <li><a href='#' > My Current Setup</a></li>
                <li> <a href="#">Zip Theme Files</a> </li>
              </ul>
            </li>
