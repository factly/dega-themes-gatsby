        ...
        >
          ...
          >
            ...
            <li>
              ...
              >
                <li>
                  <a href="#"> Remove ‘Log In’ and ‘Subscribe’ from Header</a>
                </li>
                <li>
                  <a href="#">
                ...
                <li>
                  <a href="#">
                    Remove the ‘Public’, ‘Members’ and ‘Paid’ Labels from Post
                    Card
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#"> Remove Ghost Portal / The Bottom Right Button</a>
                </li>
                <li>
            ...
            <li>
              ...
              >
                <li>
                  <a href="#"> Subscribe list</a>
                </li>
                <li>
                  {" "}
                  <a href="#"> Remove Subscribe Form</a>{" "}
                </li>
                <li>
                  {" "}
                  <a href="#"> Remove Home Hero</a>{" "}
                </li>
              </ul>
            </li>
            <li>
              ...
              >
                <li>
                  <a href="#"> Homepage Podcasts</a>
                </li>
                <li>
                  {" "}
                  <a href="#"> Show All Posts on the Homepage</a>{" "}
                </li>
                <li>
                  {" "}
                  <a href="#">Blog Page</a>{" "}
            ...
            <li>
              ...
              >
                <li>
                  {" "}
                  <a href="#">Podcast RSS Feed URL</a>{" "}
                </li>
                <li>
                  {" "}
                  <a href="#"> Blog RSS Feed URL</a>{" "}
                </li>
              </ul>
            </li>
            <li>
