    ...
    <Layout>
      ...
      >
        ...
        >
          ...
          >
            ...
            <li>
              ...
              >
                <li>
                  <a href="#Hero_section">Hero Section</a>
                </li>
                <li>
                  <a href="#Tags_section">Tags Section</a>
                </li>
                <li>
                  <a href="#Editor_section">Editor's Picks Section</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              >
                ...
                <li>
                  <a href="#">Chaging Colors With CSS Variables</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              >
                ...
                <li>
                  <a href="#">Newsletters Page</a>
                </li>
              </ul>
            </li>
            <li>
              {" "}
              <a href="#"> Post Featured Image Size</a>
            </li>
            <li>
              {" "}
              <a href="#">Navigation</a>
              ...
              >
                <li>
                  {" "}
                  <a href="#">Secondary Navigation / Footer</a>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              <a href="#">Footer Social Media Links</a>
            </li>
            <li>
              <a href="#">Languages</a>
              <ul
            ...
            <li>
              <a href="#">Typography Drop Caps</a>
            </li>
            <li>
              <a href="#">Changing Theme Typeface</a>
            </li>
            <li>
              <a href="#">Loading Custom Typeface</a>
            </li>
            <li>
              <a href="#">RSS Feed URL</a>
            </li>
            <li>
            ...
            <li>
              <a href="#">Remove Author Name</a>
            </li>
            <li>
              <a href="#">Remove Post Date</a>
            </li>
            <li>
              <a href="#">Remove Reading Time</a>
            </li>
            <li>
              <a href="#">Theme Deployment</a>
              <ul
                sx={{
                  ml: "20px",
                  mt: "8px",
        ...
        >
          ...
          <h2 id="Hero_section" sx={{ fontSize: "20px", mt: "32px" }}>
            Hero Section
          </h2>
          <p sx={{ mt: "16px" }}>
            The homepage hero section will include three columns—two for
            featured posts and one for the latest posts.
          </p>
          <p sx={{ mt: "32px" }}>
            The center and left columns will include the most recent three
            featured posts. To make a post as featured, you can do that from the
            post setting by checking the <strong>Feature this post</strong>{" "}
            checkbox.
          </p>
          <p sx={{ mt: "32px" }}>
            The right column will include the most recent six posts. Clicking
            the <strong>Latest</strong> header will take you to the Latest page,
            where you can see all the recent posts.
          </p>
          <img
            sx={{
              maxWidth: "682px",
        ...
        >
          ...
          >
            You can add many tag sections to the homepage; each section will
            show the recent four posts by the tag. To set this up:
          </p>
          <ol
            sx={{
              mt: "32px",
          ...
          >
            <li>
              Go to the Ghost admin Settings {">"} Design {">"} Site design{" "}
              {">"} Homepage
            </li>
            <li>
              In the <strong>Tag slugs for home sections</strong> input, add all
              the Tags Slug you want to include separated by (,). No spaces
              between commas.
            </li>
          </ol>
          ...
          >
            To get the Tag Slug, you can find it on each Tag page from the
            admin.
          </p>
        ...
        >
          ...
          >
            The Editors’ Picks section will show four posts with the
            hash-editors-picks tag.
          </p>
          <ol
            sx={{
              mt: "32px",
          ...
          >
            <li>
              Go to your admin Tags page, and click the top right{" "}
              <strong>Internal tags</strong> tab.
            </li>
            <li>
              Click the <strong>New tag</strong> button.
            </li>
            <li>
              In the name field, add <strong>#editors-picks</strong>
            </li>
            <li>
          ...
          >
            Then, select the #editors-picks from the post Tags setting for each
            post you want to highlight here.
          </p>
          <img
            sx={{
              height: "118px",
            }}
            src="/images/internal_tag_post.png"
            alt=""
          />
        </div>
      </div>
