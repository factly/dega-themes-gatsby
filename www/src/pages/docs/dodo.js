...
const dodoPage = () => {
  return (
    <Layout>
      <Seo
        title="Documentation | Dodo Theme"
        description=""
      />
      <div
        sx={{
      ...
      >
        ...
        <p sx={{
          ...
          "&:hover": { color: "blue" },
        }} href="/themes/dodo">Dodo</a> - documentation</p>
        <h1
          sx={{
            display: 'flex',
            justifyContent: ['center', 'null', 'start'],
        ...
        >
          ...
          <div sx={{
            ...
            <p sx={{ background: '#FAFAFA', padding: '16px', fontSize: '20px', fontWeight: '600', mt: '16px' }}>npm install @factly/gatsby-theme-dodo</p>
            <h4 sx={{ mt: '16px' }}>with yarn:</h4>
            <p sx={{ background: '#FAFAFA', padding: '16px', fontSize: '20px', fontWeight: '600', mt: '16px' }}>yarn add @factly/gatsby-theme-dodo</p>
          </div>
          <div sx={{
            background: '#E7F5FB',
            padding: '32px',
     ...
     `
        ...
        <div id='Theme shadowing'
          ...
          <ul sx={{
            ...
            <li>3. In the `index.js` file, export a theme object that includes the custom styles and components you want to use.</li>
          </ul>
          <p sx={{
            mt: '16px',
            'a: hover': {
