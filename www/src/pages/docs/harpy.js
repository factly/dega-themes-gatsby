  ...
  <Layout>
    ...
    >
      ...
      <div sx={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        <span> - </span>
        <a sx={{ color: '#525252', fontSize: '20px', fontWeight: 400 }} href="">
          Documentation
        </a>
      </div>
      <div
      ...
      <div id="Theme_Installation">
        ...
        <p sx={{ mt: '16px' }}>
          ...
          it on Mac or by right-clicking and selecting “Extract All” in Windows.
        </p>
        <p sx={{ mt: '32px' }}>
        ...
        <ol sx={{ mt: '32px', ml: '18px', li: { mt: '8px' } }}>
          ...
          <li>
            Click <strong>Upload theme</strong> and select the tripoli.zip theme
            file.
          </li>
          <li>
