    ...
    <Layout>
      ...
      >
        ...
        <p sx={{
          ...
          textDecoration: "underline",
          "&:hover": { color: "blue" },
        }} href="/themes/harpy">Harpy</a> documentation</p>
        ...
        >
          ...
          <div sx={{
            ...
            <p sx={{ background: '#FAFAFA', padding: '16px', fontSize: '20px', fontWeight: '600', mt: '16px' }}>npm install @factly/gatsby-theme-harpy</p>
            <h4 sx={{ mt: '16px' }}>with yarn:</h4>
            <p sx={{ background: '#FAFAFA', padding: '16px', fontSize: '20px', fontWeight: '600', mt: '16px' }}>yarn add @factly/gatsby-theme-harpy</p>
          </div>
          <div sx={{
            background: '#E7F5FB',
            padding: '32px',
