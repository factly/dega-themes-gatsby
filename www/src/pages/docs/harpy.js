      ...
      >
        ...
        >
          ...
          <div sx={{
            ...
            with npm:
            <p sx={{ background: '#FAFAFA', padding: '16px', fontSize: '20px', fontWeight: '600' }}>npm install @factly/gatsby-theme-harpy</p>
            with yarn:
            <p sx={{ background: '#FAFAFA', padding: '16px', fontSize: '20px', fontWeight: '600' }}>yarn add @factly/gatsby-theme-harpy</p>
          </div>
          <div sx={{
            background: '#E7F5FB',
            padding: '32px',
